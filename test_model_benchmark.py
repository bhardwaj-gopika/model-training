...
# Ensure the modeling-241-t directory is importable (for BeamOutputModel, pv_mapping)
...
from pv_mapping import sim_to_machine_array, machine_input_names
...
class TestEvaluate:
    ...
    def test_covariance_eigenvalues_reasonable(self, machine_model):
        ...
        # Allow small negative eigenvalues relative to the largest eigenvalue (numerical noise)
    ...
    def test_covariance_matches_reference(self, machine_model):
        ...
        result = machine_model.evaluate(EXAMPLE_INPUT)
        cov = result["covariance_matrix"]
        torch.testing.assert_close(cov, EXPECTED_COVARIANCE, atol=1e-2, rtol=1e-3)
...
class TestBeamOutputModel:
    ...
    def test_beam_particle_dimensions(self, beam_model):
        beam_model.set(EXAMPLE_INPUT)
        output_beam = beam_model.final_particles
        # All phase-space coordinates should be populated
    ...
    def test_beam_mean_near_zero(self, beam_model):
        ...
        beam_model.set(EXAMPLE_INPUT)
        output_beam = beam_model.final_particles
        # With 10k particles, mean should be small relative to std
    ...
    def test_beam_std_x_in_expected_range(self, beam_model):
        ...
        # Allow 20% tolerance for sampling noise
...
class TestPVMapping:
    ...
    def test_roundtrip_conversion(self):
        ...
        from pv_mapping import machine_to_sim_array
